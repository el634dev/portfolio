    ...
    return (
      <div className={styles.footer}>
        <div className={styles.footerLinks}>
          <Link href='https://github.com/el634dev' className={[navStyles.navbarLink, styles.footerLinks]} target='_blank' icon: require("../assets/icons/github.png").default>GitHub</Link>
