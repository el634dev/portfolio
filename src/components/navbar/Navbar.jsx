    ...
    <>
      ...
      <div className={styles.navbar}>
        <div className={styles.navbarContainerStart} style={navOpen ? {display: "none"} : {}}>
          <Image onClick={() => router.push('/')} className={styles.navbarBrand} width={32} height={32} src='/images/logo.svg' alt='' />
          <Link href='/'><a className={[styles.navbarBrandName, styles.navbarLink].join(' ')}>Emily L</a></Link>
        </div>
        <div className={styles.navbarContainerEnd}>
        {
          ...
          :
            <>
              <Link href='/projects' className={styles.navbarLink}><a className={styles.navbarLink}>Projects</a></Link>
        ...
        <div className={styles.navigationDrawer} style={{width: navOpen ? 350 : 0}}>
          <div className={styles.navigationDrawerHeader}>
            <div className={styles.navigationDrawerBrandContainer}>
              <Image onClick={() => router.push('/')} className={styles.navbarBrand} src='/images/logo.svg' width={32} height={32} alt='' />
              <Link href='/'><a className={[styles.navbarBrandName, styles.navbarLink].join(' ')}>Emily L</a></Link>
            </div>
          ...
          <div className={styles.navigationDrawerBody}>
            ...
            <Link href='/projects' className={styles.navigationDrawerLink}><a className={styles.navigationDrawerLink}>Projects</a></Link>
